                    ...
                    <form class="form-horizontal form-label-left" id="myForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-9 col-xs-12">
                                <input type="text" name="nama_perusahaan" class="form-control" value="<?=isset($list_perusahaan['nama_perusahaan'])? $list_perusahaan['nama_perusahaan'] : set_value('nama_perusahaan');?>">
                            </div>
                        </div>
